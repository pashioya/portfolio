...
const DottedTimelineConnector = React.forwardRef<
  HTMLDivElement,
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'absolute top-[5px] left-[30px] -translate-x-1/2 translate-y-2 h-full border-l-2 border-dotted border-primary',
      className,
    )}
    {...props}
  />
...
DottedTimelineConnector.displayName = 'DottedTimelineConnector';
...
>(({ className, children, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      'font-semibold leading-none tracking-tight text-secondary-foreground text-wrap h-12',
      className,
    )}
    {...props}
  >
